...
class TestDescriptionTemplate(unittest.TestCase):
    ...
    def test_sample_context_shape(self) -> None:
        ...
        self.assertIn("smashrun_activity_badges", context)
        ...
        self.assertIn("activity_badges", context["smashrun"])
    ...
    def test_profile_workspace_defaults(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            treadmill_template = get_active_template(settings, profile_id="treadmill")
            self.assertIn("Treadmill Session", treadmill_template["template"])
            self.assertNotIn("Treadmill Elevation", treadmill_template["template"])
            self.assertNotIn("Incline", treadmill_template["template"])
